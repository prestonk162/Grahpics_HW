...
Material::Material()
{
    ...
    setShiness(50.0f);
    setOpaqueness(true);
    setIndexOfRefraction(0.0f);
    setReflectioness(1.0);
}
...
void Material::setReflectioness(const GLfloat& r)
{
    reflectioness = r;
}

void Material::setOpaqueness(const GLboolean& isOpaque)
{
    opaque = isOpaque;
}
void Material::setIndexOfRefraction(const GLfloat& n)
{
...
const GLfloat Material::getReflectioness(void) const
{
    return reflectioness;
}
const GLfloat Material::getIndexOfRefraction(void) const
{
    return opaque ? 0.0f : index_of_refraction;
}

const GLboolean Material::isOpaque(void) const
{
    return opaque;
}